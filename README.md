...
<body>
  <div class="header screen-only">
    <div>
      ...
      <div class="header-sub">Project NOC Status – Online Tracker</div>
    </div>
    <div class="header-buttons">
      <button class="btn-save" onclick="saveProgress()">💾 Save</button>
      <button class="btn-load" onclick="loadProgress()">📥 Load</button>
      <button class="btn-export" onclick="exportPDF()">📄 Export PDF</button>
      <button class="btn-share" onclick="shareTracker()">🔗 Share Link</button>
  ...
  <div class="container screen-only">
    ...
    <div class="card">
      ...
      <div class="small-note">
        Use comments for cases in orange, red, or yellow (Need Modification, Rejection, In Progress).
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="small-note">
        Created by: Eng. Mohamed Mamdouh Salem.<br>
        <strong>To export as PDF:</strong> Click the “Export PDF” button above, then in the print window choose <em>“Save as PDF”</em> and click <em>Save</em>.
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function updateProgress(){
      ...
      parks.forEach((park, pIndex) => {
        ...
        if(text) text.textContent = `– ${approvedCount}/${target} approvals (${pct}%)`;
      });
    }
